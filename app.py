...
st.dataframe(
    summary.style.format({"avg_sentiment": "{:.3f}"})
          .bar(subset=["avg_sentiment"], color=['#ff9999','#99ff99'])
...
def add_footer():
    ...
    st.markdown(
        ...
        "<a href='https://github.com/pardissh/Social_Media_Trend_Analysis' target='_blank'>GitHub Repo</a>"
        "</p>",
...
st.title("Social Media Trend & Sentiment Analysis")
st.markdown("**Twitter trends using LDA + VADER** • Project by Pardis")
...
st.caption("Project by Pardis • Final NLP Project 2025")