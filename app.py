...
with col1:
    ...
    if st.session_state.pos_wc:
        ...
        st.info("No strongly positive tweets in this sample")
...
with col2:
    ...
    if st.session_state.neg_wc:
        ...
        st.info("No strongly negative tweets in this sample")
